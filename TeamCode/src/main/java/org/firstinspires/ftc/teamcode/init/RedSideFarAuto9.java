...
@Autonomous(name="Red Far Zone 9", group ="Autos")
public class RedSideFarAuto9 extends LinearOpMode {
    ...
    public void runOpMode() throws  InterruptedException {
        ...
        mecanumDrive(0.00, 0.00, 0.00, 00.0, 0, -200, 0.00, 0.00, 0.00, 3.0);
        // Shooting artifacts
        mecanumDrive(0.00, 0.00, 0.00, 0.00, 1.00, -200, 1.00, 0.00, -0.5, 1);
        // Stalling a bit
        mecanumDrive(0.00, 0.00, 0.00, 0.00, 0, -200, 0.00, 0.00, 0.00, 1.5);

        // Moving Forward so we don't scrape the wall
        mecanumDrive(0.75, 0.75, 0.75, 0.75, 0, -200, 0.00, 0.00, 0.00, 0.2);
        // Turns Left
        mecanumDrive(0.75, -0.75, 0.75, -0.75, 0, -200, 0.00, 0.00, 0.00, 0.3);
        // Moves Left to line up with the wall
        mecanumDrive(0.75, -0.75, -0.75, 0.75, 0, -200, 0.00, 0.00, 0.00 ,0.2);
        // Moves back into the wall
        mecanumDrive(0.5, -0.5, -0.5, 0.5, 0, -200, 0.00, 0.00, 0.00, 0.4);

        // Wait for a moment
        mecanumDrive(0.00, 0.00, 0.00, 0.00, 0, -200, 0.00, 1.00, -0.5, 1.0);
        // Moves Backwards while intaking
        mecanumDrive(-0.3, -0.3, -0.3, -0.3, 0, -200, 0.00, 1.00, -0.5, 3.0);
        // Moving artifacts along the intake
        mecanumDrive(0.00, 0.00, 0.00, 0.00, 0, -200, 1.00, 1.00, -0.5, 2.5);

        // Moving back into position
        mecanumDrive(0.75, 0.75, 0.75, 0.75, 0, -200, 0.00, 0.00, 0.00, 1.0);
        mecanumDrive(-0.75, 0.75, 0.75, -0.75, 0, -200, 0.00, 0.00, 0.00, 0.2);
        mecanumDrive(-0.75, 0.75, -0.75, 0.75, 0, -200, 0.00, 0.00, 0.00, 0.3);
        mecanumDrive(-0.75, -0.75, -0.75, -0.75, 0, -200, 0.00, 0.00, 0.00, 0.2);

        // Stalling a bit
        mecanumDrive(0.00, 0.00, 0.00, 0.00, 0, -200, 0.00, 1.00, 0.00, 1.5);
        // Shooting artifacts
        mecanumDrive(0.00, 0.00, 0.00, 0.00, 1.00, -200, 1.00, 1.00, -0.5, 1.0);

        // Drive forward to line up with artifacts
        mecanumDrive(0.75, 0.75, 0.75, 0.75, 0, -200, 0, 0, 0, 0.5);
        // Turn Left
        mecanumDrive(0.75, -0.75, 0.75, -0.75, 0, -200, 0, 0, 0, 0.4);

        // Moves Backwards while intaking
        mecanumDrive(-0.3, -0.3, -0.3, -0.3, 0, -200, 0.00, 1.00, -0.5, 2.3);
        // Moving artifacts along the intake
        mecanumDrive(0.00, 0.00, 0.00, 0.00, 0, -200, 1.00, 1.00, -0.5, 2.0);

        // Moving back into position
        mecanumDrive(0.75, 0.75, 0.75, 0.75, 0, -200, 0, 0, 0, 0.85);
        mecanumDrive( -0.75, 0.75, -0.75, 0.75, 0, -200, 0, 0, 0, 0.4);
        mecanumDrive(-0.75, -0.75, -0.75, -0.75, 0, -200, 0, 0, 0, 0.5);

        // Giving the turret time to charge up
        mecanumDrive(0.00, 0.00, 0.00, 00.0, 0, -200, 0.00, 0.00, 0.00, 2.0);
        // Shooting artifacts
        mecanumDrive(0.00, 0.00, 0.00, 0.00, 1.00, -200, 1.00, 0.00, -0.5, 0.8);

        // moves for leave points
        mecanumDrive(-0.75, 0.75, 0.75, -0.75, 0, -200, 0.00, 0.00, 0.00, 0.4);
